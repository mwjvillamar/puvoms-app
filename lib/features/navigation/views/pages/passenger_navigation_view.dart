...
import 'package:puvoms/features/navigation/controllers/passenger_navigation_controller.dart';

class PassengerNavigationView extends StatefulWidget {

  const PassengerNavigationView({Key? key}) : super(key: key);

  @override
  State<PassengerNavigationView> createState() => _NavigationViewState();
}

class _NavigationViewState extends State<PassengerNavigationView>{
  ...
  Widget buildOffstageNavigator(String tab) {
    return Offstage(
      ...
      child: PassengerNavigationController(
